...
_AllMatchesIterable: {"": "IterableBase;_re,_liblib8$_string",
  get$iterator: function(_) {
    return new $._AllMatchesIterator(this._re, this._liblib8$_string, null);
  },
  "+iterator": 0,
  $asIterable: function() {
    return [$.Match];
...
_AllMatchesIterator: {"": "Object;_regExp,_liblib8$_string,_liblib8$_current",
  ...
  moveNext$0: function() {
    ...
    if (t1 != null) {
      ...
      index = 0;
    this._liblib8$_current = this._regExp._execGlobal$2(this._liblib8$_string, index);
    if (this._liblib8$_current == null) {
      this._liblib8$_string = null;
      return false;
    }
    return true;
  },
...
LinkedHashSet: {"": "_HashSetBase;_liblib2$_length,_strings,_nums,_rest,_first,_last,_modifications",
  ...
  get$last: function(_) {
    ...
    if (t1 == null)
      throw $.wrapException(new $.StateError("No elements"));
    return t1.get$_liblib2$_element();
  },
  "+last": 0,
  add$1: function(_, element) {
    var strings, table, nums, rest, hash, bucket;
...
Object: {"": ";",
  ...
  call$4$parents: function($0, $1, $2, $3) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("call", "call$4$parents", 0, [$0, $1, $2, $3], ["parents"]));
  },
  ...
  createBinaryFile$4$parents: function($0, $1, $2, $3) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("createBinaryFile", "createBinaryFile$4$parents", 0, [$0, $1, $2, $3], ["parents"]));
  },
...
Uri: {"": "Object;_liblib1$_port,_path,scheme,userInfo,host,query,fragment,_pathSegments,_queryParameters",
  ...
  $eq: function(_, other) {
    ...
    if (typeof other !== "object" || other === null || !$.getInterceptor(other).$isUri)
      return false;
    return $.$eq(this.scheme, other.scheme) && this.userInfo === other.userInfo && this.host === other.host && $.$eq(this._liblib1$_port, other.get$port(other)) && $.$eq(this._path, other.get$path(other)) && $.$eq(this.query, other.query) && $.$eq(this.fragment, other.fragment);
  },
  "+==:1:0": 0,
  get$hashCode: function(_) {
...
_UnmodifiableMap: {"": "Object;_liblib1$_map",
  $index: function(_, key) {
  ...
  "+remove:1:0": 0,
  forEach$1: function(_, f) {
    return $.forEach$1$ax(this._liblib1$_map, f);
  },
  "+forEach:1:0": 0,
  get$keys: function() {
    return this._liblib1$_map.get$keys();
  },
  "+keys": 0,
  get$values: function(_) {
    return $.get$values$x(this._liblib1$_map);
  },
  "+values": 0,
  get$length: function(_) {
    return $.get$length$asx(this._liblib1$_map);
  },
  "+length": 0,
  get$isEmpty: function(_) {
    return $.get$isEmpty$asx(this._liblib1$_map);
  },
  "+isEmpty": 0,
  get$isNotEmpty: function(_) {
    return $.get$isNotEmpty$asx(this._liblib1$_map);
  },
  "+isNotEmpty": 0,
  $isMap: true
},
...
CssStyleDeclarationBase: {"": "Object;",
  ...
  "+left": 0,
  set$outlineColor: function(receiver, value) {
    this.setProperty$3(receiver, "outline-color", value, "");
  },
  get$page: function(receiver) {
...
Element: {"": "Node;id=,innerHtml:innerHTML},title%,className%,offsetLeft=,offsetTop=,$$dom_children:children=",
  get$attributes: function(receiver) {
...
_serialize: function(message) {
  ...
  if (message == null)
    ...
    if (t1)
      ...
      return ["funcref", message._id, message._liblib7$_port];
    else if (typeof message === "object" && message !== null && !!$.getInterceptor(message).$isProxy)
      return ["objref", message._id, message._liblib7$_port];
      ...
      return ["objref", t1.add$1(t1, message), new $._LocalSendPortSync($.get$_proxiedObjectTable()._liblib7$_port)];
    }
  }
},
...
Callback: {"": "Object;_manualDispose,_id<,_callback",
  ...
  "+_initialize:1:0": 0,
  toJs$0: function() {
    return new $.FunctionProxy(new $._LocalSendPortSync($.get$_proxiedObjectTable()._liblib7$_port), this._id);
  },
  "+toJs:0:0": 0,
...
Proxy: {"": "Object;_liblib7$_port,_id<",
  toJs$0: function() {
    return this;
  },
  "+toJs:0:0": 0,
...
Proxy__forward: function(receiver, member, kind, args) {
  var result, t1;
  $._enterScopeIfNeeded();
  result = receiver._liblib7$_port.callSync$1([receiver._id, member, kind, $.toList$0$ax($.map$1$ax(args, $._serialize$closure))]);
  t1 = $.getInterceptor$asx(result);
...
FunctionProxy: {"": "Proxy;_liblib7$_port,_id",
...
_ProxiedObjectTable: {"": "Object;_name,_nextId,_deletedCount,_registry<,_liblib7$_port,_globalIds,_handleStack,_scopeIndices",
  ...
  _ProxiedObjectTable$0: function() {
    this._liblib7$_port.receive$1(new $._ProxiedObjectTable_closure(this));
  },
  static: {
...
_deserialize_deserializeFunction: {"": "Closure;",
  call$1: function(message) {
    ...
    if ($.$eq(port, new $._LocalSendPortSync($.get$_proxiedObjectTable()._liblib7$_port))) {
...
showPrompt: function($prompt, defaultText) {
  ...
  t2 = new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, new $.showPrompt_closure(textBox, t1), t2._useCapture);
  t2._tryResume$0();
  subs.push(t2);
  ...
  t2 = new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, new $.showPrompt_closure0(textBox, t1), t2._useCapture);
  t2._tryResume$0();
  subs.push(t2);
  t2 = document.querySelector("#promptCancel");
  t2.get$onClick;
  t2 = new $._EventStream(t2, t3, false);
  t2 = new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, new $.showPrompt_closure1(defaultText, t1), t2._useCapture);
  t2._tryResume$0();
  subs.push(t2);
  backdrop.get$onClick;
  t3 = new $._EventStream(backdrop, t3, false);
  t3 = new $._EventStreamSubscription(0, t3._liblib0$_target, t3._eventType, new $.showPrompt_closure2(defaultText, t1), t3._useCapture);
  t3._tryResume$0();
  subs.push(t3);
...
startEditor: function(doc) {
  ...
  new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, new $.startEditor_closure0(ed), t2._useCapture)._tryResume$0();
  ...
  new $._EventStreamSubscription(0, t1._liblib0$_target, t1._eventType, new $.startEditor_closure2(ed), t1._useCapture)._tryResume$0();
...
startPlayer: function(movie, big) {
  ...
  new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, new $.startPlayer_closure0(movie, player, exportButton, exportLink), t2._useCapture)._tryResume$0();
  ...
  new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, new $.startPlayer_closure1(t1, player), t2._useCapture)._tryResume$0();
  t2 = document;
  $.EventStreamProvider_keyup.forTarget$2$useCapture;
  t2 = new $._EventStream(t2, $.EventStreamProvider_keyup._eventType, false);
  new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, new $.startPlayer_closure2(t1, player), t2._useCapture)._tryResume$0();
...
Drive: {"": "Object;",
  ...
  "+createDoc:2:0": 0,
  createBinaryFile$4$parents: function(filename, mimeType, bytes, parents) {
    var multipartBody, t1, t2, t3, request, c;
    multipartBody = "\r\n--BOUNDARY\r\nContent-Type: application/json\r\n\r\n" + $._JsonStringifier_stringify($.makeLiteralMap(["title", filename, "mimeType", mimeType, "parents", $.List_List$from($.map$1$ax(parents, new $.Drive_createBinaryFile_closure()), true)])) + "\r\n--BOUNDARY\r\nContent-Type: image/gif\r\nContent-Transfer-Encoding: base64\r\n\r\n" + $._CryptoUtils_bytesToBase64(bytes, false, false) + "\r\n--BOUNDARY--";
    ...
    c = new $._AsyncCompleter(new $._FutureImpl(0, $.get$_Zone__current(), null), false);
    c._Completer$0();
    request.execute$1($.Callback$once(new $.Drive_createBinaryFile_closure0(c), false));
    return c.future;
  },
  "+createBinaryFile:3:1": 0,
...
Drive_createBinaryFile_closure: {"": "Closure;",
  call$1: function(id) {
    return $.makeLiteralMap(["id", id]);
  },
  "+call:1:0": 0,
  $isFunction: true
},
...
Drive_createBinaryFile_closure0: {"": "Closure;c_0",
  call$2: function(fileInfo, unused) {
    var t1, t2;
    t1 = $.getInterceptor$asx(fileInfo);
    $.Primitives_printString("document " + $.S(t1.$index(fileInfo, "id")) + " created");
...
Drive_loadFileMeta__closure: {"": "Closure;c_2",
  call$2: function(file, unused) {
    var t1 = this.c_2;
    return t1.complete$1(t1, $.FileMeta$(file));
  },
  "+call:2:0": 0,
  $isFunction: true
},
...
Drive_setTitle__closure: {"": "Closure;c_3",
  call$2: function(file, unused) {
    var t1 = this.c_3;
    t1.complete$1(t1, $.FileMeta$(file));
  },
  "+call:2:0": 0,
  $isFunction: true
},
...
FileMeta: {"": "Object;title>,editable<,parents<", static: {
FileMeta$: function(file) {
  var t1 = $.getInterceptor$asx(file);
  return new $.FileMeta(t1.$index(file, "title"), t1.$index(file, "editable"), $.List_List$generate($.get$length$asx(t1.$index(file, "parents")), new $.FileMeta_closure(file), true));
},
...
FileMeta_closure: {"": "Closure;file_0",
  call$1: function(i) {
    return $.$index$asx($.$index$asx($.$index$asx(this.file_0, "parents"), i), "id");
  },
  "+call:1:0": 0,
  $isFunction: true
},
...
MovieModel: {"": "Object;palette,grids,doc<",
  exportGif$2: function(filename, fps) {
    var bytes, c;
    bytes = $.makeSnapshot(this.grids, fps);
    c = new $._AsyncCompleter(new $._FutureImpl(0, $.get$_Zone__current(), null), false);
    c._Completer$0();
    this.doc.loadFileMeta$0().then$1(new $.MovieModel_exportGif_closure(this, filename, bytes)).then$1(new $.MovieModel_exportGif_closure0(c));
    return c.future;
  },
  "+exportGif:2:0": 0,
...
MovieModel_exportGif_closure: {"": "Closure;this_0,filename_1,bytes_2",
  call$1: function(m) {
    $.Primitives_printString("parents: " + $.S(m.get$parents()));
    return this.this_0.get$doc().get$drive().createBinaryFile$4$parents(this.filename_1, "image/gif", this.bytes_2, m.get$parents());
  },
  "+call:1:0": 0,
  $isFunction: true
},

"+MovieModel_exportGif_closure": 0,

MovieModel_exportGif_closure0: {"": "Closure;c_3",
  call$1: function(s) {
    var t1 = this.c_3;
    t1.complete$1(t1, s);
  },
...
FrameListView: {"": "Object;player<,elt<,views",
  ...
  FrameListView$2: function(movie, player) {
    ...
    new $._EventStreamSubscription(0, t1._liblib0$_target, t1._eventType, new $.FrameListView_closure(this), t1._useCapture)._tryResume$0();
...
GridView: {"": "Object;grid<,pixelsize<,elt<,damage@,_cancelOnChange,_mouseDownSub,_onModelChange?",
  ...
  enablePainting$2: function(editor, palette) {
    ...
    new $._EventStreamSubscription(0, t4._liblib0$_target, t4._eventType, t2, t4._useCapture)._tryResume$0();
    t3.get$onTouchMove;
    ...
    new $._EventStreamSubscription(0, t4._liblib0$_target, t4._eventType, new $.GridView_enablePainting_closure(this, editor, t2), t4._useCapture)._tryResume$0();
    ...
    t4 = new $._EventStreamSubscription(0, t4._liblib0$_target, t4._eventType, new $.GridView_enablePainting_closure1(t1, this, editor, new $.GridView_enablePainting__mousepaint(this, editor, palette)), t4._useCapture);
    t4._tryResume$0();
    ...
    new $._EventStreamSubscription(0, t4._liblib0$_target, t4._eventType, new $.GridView_enablePainting_closure2(t1), t4._useCapture)._tryResume$0();
    t3.get$onMouseOut;
    $.EventStreamProvider_mouseout.forTarget$2$useCapture;
    t3 = new $._EventStream(t3, $.EventStreamProvider_mouseout._eventType, false);
    new $._EventStreamSubscription(0, t3._liblib0$_target, t3._eventType, new $.GridView_enablePainting_closure3(t1), t3._useCapture)._tryResume$0();
  },
  ...
  GridView$2: function(g, pixelsize) {
    ...
    t1 = new $._EventStreamSubscription(0, t1._liblib0$_target, t1._eventType, new $.GridView_closure(), t1._useCapture);
    t1._tryResume$0();
...
GridView_enablePainting_closure1: {"": "Closure;box_0,this_14,editor_15,_mousepaint_16",
  call$1: function(e) {
    ...
    if ($.$eq($.get$button$x(e), 0)) {
      ...
      sub = new $._EventStreamSubscription(0, t3._liblib0$_target, t3._eventType, t1, t3._useCapture);
      sub._tryResume$0();
...
StrokeSet: {"": "Object;colorIndex<,strokes<",
  ...
  endPaint$0: function() {
    for (var t1 = new $.HashMapKeyIterable(this.strokes)._map, t1 = new $.HashMapKeyIterator(t1, t1._computeKeys$0(), 0, null); t1.moveNext$0();)
      t1._liblib2$_current.endPaint$0();
  },
  "+endPaint:0:0": 0,
  undo$0: function() {
    var t1, t2, g;
...
PaletteView: {"": "Object;m<,elt<,cells",
  _initTable$1: function(width) {
    ...
    for (t1 = this.m.colors, t2 = this.cells, t3 = t2.length, t4 = this.elt, i = 0; i < t1.length; ++i) {
      ...
      if (i >= t1.length)
        throw $.ioore(i);
      $.set$backgroundColor$x(t5, t1[i]);
      t5 = td.style;
      if (i >= t1.length)
        throw $.ioore(i);
      $.set$outlineColor$x(t5, t1[i]);
      if (i >= t3)
        throw $.ioore(i);
      t2[i] = td;
      row.appendChild(td);
  ...
  PaletteView$2: function(model, width) {
    ...
    $.EventStreamProvider_click.forTarget$2$useCapture;
    t1 = new $._EventStream(t1, $.EventStreamProvider_click._eventType, false);
    new $._EventStreamSubscription(0, t1._liblib0$_target, t1._eventType, new $.PaletteView_closure(this), t1._useCapture)._tryResume$0();
...
start_closure: {"": "Closure;loc_0",
  call$1: function(drive) {
    ...
    if (t2.$eq(t1, "create"))
      ...
      new $._EventStreamSubscription(0, t1._liblib0$_target, t1._eventType, new $.start__closure(drive), t1._useCapture)._tryResume$0();
...
StateToken_StateToken$load: function(loc) {
  ...
  t1.$index;
  state = $.$index$asx(t1._liblib1$_map, "state");
  if (state == null)
    return new $.StateToken("none", [], null);
...
PlayerView: {"": "Object;player<,elt<,step,play,slider<,reverse",
  ...
  PlayerView$1: function(player) {
    ...
    new $._EventStreamSubscription(0, t1._liblib0$_target, t1._eventType, new $.PlayerView_closure(this), t1._useCapture)._tryResume$0();
    t5.get$onClick;
    t5 = new $._EventStream(t5, t4, false);
    new $._EventStreamSubscription(0, t5._liblib0$_target, t5._eventType, new $.PlayerView_closure0(this), t5._useCapture)._tryResume$0();
    t2.get$onChange;
    $.EventStreamProvider_change.forTarget$2$useCapture;
    t2 = new $._EventStream(t2, $.EventStreamProvider_change._eventType, false);
    new $._EventStreamSubscription(0, t2._liblib0$_target, t2._eventType, new $.PlayerView_closure1(this), t2._useCapture)._tryResume$0();
    t3.get$onClick;
    t4 = new $._EventStream(t3, t4, false);
    new $._EventStreamSubscription(0, t4._liblib0$_target, t4._eventType, new $.PlayerView_closure2(this), t4._useCapture)._tryResume$0();
...
$.set$outlineColor$x = function(receiver, value) {
  return $.getInterceptor$x(receiver).set$outlineColor(receiver, value);
};
...
// Native classes
$.defineNativeMethods("CanvasGradient|CanvasPattern|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SQLException|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString", $.Interceptor);

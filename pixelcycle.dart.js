...
$$.AnchorElement = {"": "Element;search=,target=,type}",
...
$$.InputElement = {"": "Element;disabled},files=,height%,max},min},type},value%,width%", $isElement: true, $asElement: null, $isNode: true, $asNode: null, $isEventTarget: true, $asEventTarget: null};
...
$$.OptionElement = {"": "Element;disabled},index=,selected},value%"};
...
$$.TextAreaElement = {"": "Element;disabled},value%"};
...
$$.MediaStreamAudioDestinationNode = {"": "AudioSourceNode;stream="};
...
_NativeJsSendPort_send_closure: {"": "Closure;this_1,message_2,replyTo_3",
  call$0: function() {
    ...
    t3.enqueue$3;
    t3 = t3.events;
    t3._liblib1$_add$1(t3, new $._IsolateEvent(isolate, new $._NativeJsSendPort_send__closure(t1, t2, shouldSerialize), t4));
  },
  $isFunction: true
},
...
TimerImpl: {"": "Object;_once,_inEventLoop,_handle?",
  ...
  TimerImpl$2: function(milliseconds, callback) {
    ...
    if (t1) {
      ...
      t1.enqueue$3;
      t1 = t1.events;
      t1._liblib1$_add$1(t1, new $._IsolateEvent(t2, callback, "timer"));
...
IsolateNatives__processWorkerMessage: function(sender, e) {
  ...
  switch (t1.$index(msg, "command")) {
    case "start":
      ...
      t2.enqueue$3;
      t2 = t2.events;
      t2._liblib1$_add$1(t2, new $._IsolateEvent(context, new $.IsolateNatives__processWorkerMessage_closure(entryPoint, replyTo), "worker-start"));
...
_StreamImpl: {"": "Stream;_state@",
  ...
  get$_add: function(receiver) {
    return new $.BoundClosure$i1(this, "_add$1", receiver);
  },
...
_MultiStreamImpl: {"": "_StreamImpl;_nextLink@,_previousLink@,_state,_pendingEvents",
  ...
  _addListener$1: function(listener) {
    ...
    if (this === t1 && $.$eq($.$and$n(this._state, 24), 0)) {
...
_StreamSubscriptionImpl: {"": "_StreamListener;_cancelOnError<,_liblib5$_onData,_onError,_onDone,_liblib5$_source,_state,_nextLink,_previousLink",
  ...
  _sendError$1: function(error) {
    ...
    if (this._cancelOnError)
      this._liblib5$_source._cancel$1(this);
  },
  _sendDone$0: function() {
    this._onDone$0();
  },
...
_SingleStreamMultiplexer: {"": "_MultiStreamImpl;_liblib5$_source,_subscription@,_nextLink,_previousLink,_state,_pendingEvents",
  _onSubscriptionStateChange$0: function() {
    var t1, t2;
    if (this !== this._nextLink) {
      t1 = this.get$_add(this);
      t2 = this.get$_addError();
      this._subscription = this._liblib5$_source.listen$3$onDone$onError(t1, this.get$_close(), t2);
    } else {
...
_ForwardingStream: {"": "Stream;",
  ...
  listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
    ...
    if (t1._onDone == null)
      t1._onDone = $._nullDoneHandler$closure;
    t2 = t1.get$_handleData();
    t3 = t1.get$_handleError();
    t1._subscription = t1._stream._liblib5$_source.listen$3$onDone$onError(t2, t1.get$_handleDone(), t3);
    return t1;
  },
  listen$1: function(onData) {
    return this.listen$4$cancelOnError$onDone$onError(onData, null, null, null);
...
ListQueue: {"": "IterableBase;_table,_head,_tail,_modificationCount",
  ...
  add$1: function(_, element) {
    this._liblib1$_add$1(this, element);
  },
  remove$1: function(_, object) {
    var i, t1;
  ...
  _liblib1$_add$1: function(_, element) {
    var t1, t2;
    t1 = this._table;
    t2 = this._tail;
    if (t2 >>> 0 !== t2 || t2 >= t1.length)
...
Object: {"": ";",
  ...
  _add$1: function($receiver, $0) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("_add", "_add$1", 0, [$0], []));
  },
  ...
  load$4: function($receiver, $0, $1, $2, $3) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("load", "load$4", 0, [$0, $1, $2, $3], []));
  },
...
_EventStream: {"": "Stream;_target,_eventType,_useCapture",
  ...
  listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
    ...
    t2 = t1._onData;
    if (t2 != null && t1._liblib0$_pauseCount <= 0)
...
_EventStreamSubscription: {"": "StreamSubscription;_liblib0$_pauseCount,_target,_eventType,_onData,_useCapture",
  cancel$0: function(_) {
    var t1, t2;
    t1 = this._target;
    if (t1 == null)
...
Rect: {"": "Object;left>,top>,width>,height>",
  toString$0: function(_) {
    return "(" + this.left + ", " + $.S(this.top) + ", " + $.S(this.width) + ", " + $.S(this.height) + ")";
  },
  $eq: function(_, other) {
    var t1;
    if (other == null)
    ...
    return this.left === t1.get$left(other) && $.$eq(this.top, t1.get$top(other)) && $.$eq(this.width, t1.get$width(other)) && $.$eq(this.height, t1.get$height(other));
  },
  union$1: function(_, rect) {
    ...
    t2 = this.top;
    bottom = $.max($.$add$ns(t2, this.height), $.$add$ns(t3.get$top(rect), t3.get$height(rect)));
    left = $.min(t1, t3.get$left(rect));
    $top = $.min(t2, t3.get$top(rect));
    return new $.Rect(left, $top, right - left, bottom - $top);
  },
  floor$0: function(_) {
    return new $.Rect($.JSInt_methods.floor$0(this.left), $.floor$0$nx(this.top), $.floor$0$nx(this.width), $.floor$0$nx(this.height));
  },
  toInt$0: function(_) {
    return new $.Rect($.JSInt_methods.toInt$0(this.left), $.toInt$0$nx(this.top), $.toInt$0$nx(this.width), $.toInt$0$nx(this.height));
  },
...
_WrappedIterator: {"": "Object;_liblib0$_iterator",
  ...
  get$current: function() {
    return this._liblib0$_iterator._liblib0$_current;
  }
},
...
Uri$_fromMatch: function(m) {
  ...
  t1 = t1[8];
  t1 = t1 != null ? t1 : "";
  return new $.Uri(t3, t4, t5, t2, t7, t8, t1);
},
...
Callback: {"": "Object;_manualDispose,_liblib2$_id<,_liblib2$_callback",
  toJs$0: function() {
    return new $.FunctionProxy(new $._LocalSendPortSync($.get$_proxiedObjectTable()._liblib2$_port), this._liblib2$_id);
  },
  Callback$many$2$withThis: function(f, withThis) {
    var t1, t2, t3, t4, id;
    this._liblib2$_callback = new $.Callback$many_closure(f, withThis);
...
_deserialize_deserializeFunction: {"": "Closure;",
  call$1: function(message) {
    ...
    if ($.$eq(port, new $._LocalSendPortSync($.get$_proxiedObjectTable()._liblib2$_port))) {
...
_serialize: function(message) {
  ...
  if (message == null)
    ...
    if (t1)
      ...
      t1._handleStack.push(id);
      return ["objref", id, new $._LocalSendPortSync($.get$_proxiedObjectTable()._liblib2$_port)];
    }
  }
},
...
DomName: {"": "Object;name"}}],
["pixelcycle", {
Doc: {"": "Object;gapi<,doc,frameById<",
  getFrames$0: function() {
    var t1 = new $.CollaborativeList($.get$1$x(this.doc.getModel$0().getRoot$0(), "frames"));
    return t1.map$1(t1, new $.Doc_getFrames_closure(this));
  },
  Doc$2: function(gapi, doc) {
    var t1, t2, f;
    for (t1 = new $.CollaborativeList($.get$1$x(this.doc.getModel$0().getRoot$0(), "frames")), t1 = $.get$iterator$ax(t1.map$1(t1, new $.Doc_closure(this))), t2 = this.frameById; t1.moveNext$0() === true;) {
      f = t1.get$current();
...
Frame: {"": "Object;doc,_strokes,strokeById,onChange>,onChangeSink<",
  get$id: function(_) {
    return $.get$id$x(this._strokes.proxy);
  },
  strokesFrom$1: function(startIndex) {
    var t1, len, out, t2, t3, t4, i, proxy, id, t5, t6;
    if (startIndex !== (startIndex | 0))
      return this.strokesFrom$1$bailout(1, startIndex);
    t1 = this._strokes.proxy;
    len = $.get$length$asx(t1);
    if (typeof len !== "number")
      return this.strokesFrom$1$bailout(2, startIndex, len, t1);
    out = $.List_List(len - startIndex);
    for (t2 = $.getInterceptor$x(t1), t3 = this.strokeById, t4 = out.length, i = startIndex; i < len; ++i) {
      proxy = t2.get$1(t1, i);
      id = $.get$id$x(proxy);
  ...
  strokesFrom$1$bailout: function(state0, startIndex, len, t1) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
        ...
        len = $.get$length$asx(t1);
      case 2:
        var out, t2, t3, t4, i, t5, proxy, id, t6, t7;
        state0 = 0;
        out = $.List_List($.$sub$n(len, startIndex));
        for (t2 = $.getInterceptor$x(t1), t3 = this.strokeById, t4 = out.length, i = startIndex; t5 = $.getInterceptor$n(i), t5.$lt(i, len) === true; i = t5.$add(i, 1)) {
          proxy = t2.get$1(t1, i);
          id = $.get$id$x(proxy);
          t3.putIfAbsent$2(t3, id, new $.Frame_strokesFrom_closure(proxy));
  ...
  createStroke$1: function(colorIndex) {
    var s, t1;
    s = $.Stroke$(new $.CollaborativeMap(this.doc.doc.getModel$0().createMap$0()), colorIndex);
    t1 = this.strokeById;
    t1.$indexSet(t1, $.get$id$x(s.map.proxy), s);
    return s;
  },
  push$1: function(s) {
    var t1 = $.getInterceptor$x(s);
    t1.save$0(s);
    this._strokes.proxy.push$1(t1.get$map(s).get$proxy());
  },
  remove$1: function(_, s) {
    this._strokes.proxy.removeValue$1($.get$map$ax(s).get$proxy());
  },
  Frame$2: function(doc, _strokes) {
    var t1, t2, control, $forward;
    t1 = this._strokes.proxy;
    $._jsGlobalize.callSync$1($._serialize(t1.toJs$0()));
    t2 = new $._SingleControllerStream(null, null, null, null, null, 0, null);
    t2._updatePauseCount$1(1);
    control = new $.StreamController(t2);
    this.onChange = control.stream.asBroadcastStream$0();
    this.onChangeSink = new $._EventSinkView(control);
    $forward = new $.Frame_closure(this);
    t2 = this.doc.gapi;
    t1.addEventListener$2(t2.get$drive().get$realtime().get$EventType().get$VALUES_ADDED(), $.Callback$many($forward, false));
    t1.addEventListener$2(t2.get$drive().get$realtime().get$EventType().get$VALUES_SET(), $.Callback$many($forward, false));
    t1.addEventListener$2(t2.get$drive().get$realtime().get$EventType().get$VALUES_REMOVED(), $.Callback$many($forward, false));
  }
},
...
Frame_closure: {"": "Closure;this_0",
  call$1: function(e) {
    ...
    t3 = $.get$index$x(e);
    $._add$1$x($.get$stream$x(t2.get$_sink()), new $.FrameChange(t1, t3));
  },
  $isFunction: true
},
...
Frame_strokesFrom_closure: {"": "Closure;proxy_0",
  call$0: function() {
    ...
    $._jsGlobalize.callSync$1($._serialize(t1.map.proxy.toJs$0()));
    t1.load$0(t1);
    return t1;
  },
  $isFunction: true
...
Stroke: {"": "Object;map>,colorIndex<,xs<,ys<,data",
  map$1: function($receiver, arg0) {
    return this.map.call$1(arg0);
  },
  get$id: function(_) {
    return $.get$id$x(this.map.proxy);
  },
  get$length: function(_) {
    return $.get$length$asx(this.xs);
  },
  load$0: function(_) {
    this.data = $.parse($.get$1$x(this.map.proxy, "d"), null);
  ...
  save$0: function(_) {
    ...
    output._contents = "";
    new $._JsonStringifier(output, []).stringifyValue$1(t1);
    this.map.proxy.set$2("d", output._contents);
  },
  Stroke$deserialize$1: function(p) {
    $._jsGlobalize.callSync$1($._serialize(this.map.proxy.toJs$0()));
    this.load$0(this);
  },
  Stroke$2: function(map, colorIndex) {
    $._jsGlobalize.callSync$1($._serialize(this.map.proxy.toJs$0()));
...
startDrive_initApis: {"": "Closure;",
  call$0: function() {
    var c = $._AsyncCompleter$();
    $._enterScopeIfNeeded();
    $.load$2$x($._deserialize($._jsPortSync.callSync$1([])).get$gapi(), "auth:client,drive-realtime", $.Callback$once(new $.startDrive_initApis_closure(c), false));
    return c.future;
  },
  $isFunction: true
},
...
startDrive_authorize: {"": "Closure;",
  call$1: function(immediate) {
    ...
    $._enterScopeIfNeeded();
    t1.authorize$2($._deserialize($._jsPortConvert.callSync$1($.Proxy__serializeDataTree(t2))), $.Callback$once(new $.startDrive_authorize_closure(this, immediate, c), false));
    return c.future;
  },
  $isFunction: true
},
...
startDrive_authorize_closure: {"": "Closure;authorize_1,immediate_2,c_3",
  call$1: function(authResult) {
    ...
    if (authResult != null) {
      $._enterScopeIfNeeded();
      t1 = $._deserialize($._jsPortSync.callSync$1([])).propExists$2(authResult, "error") !== true;
    } else
      t1 = false;
    if (t1) {
...
startDrive_closure0: {"": "Closure;c_9",
  call$1: function(x) {
    ...
    t1 = this.c_9;
    $._enterScopeIfNeeded();
    t2 = $._deserialize($._jsPortSync.callSync$1([])).get$gapi();
    $._jsGlobalize.callSync$1($._serialize(t2.toJs$0()));
    if (t1._isComplete)
      $.throwExpression(new $.StateError("Future already completed"));
    t1._isComplete = true;
    t1._setFutureValue$1(new $.Drive(t2));
    return;
  },
  $isFunction: true
},
...
Drive: {"": "Object;gapi<",
  createDoc$1: function(title) {
    var c = $._AsyncCompleter$();
    this._loadApi$2("drive", "v2").then$1(new $.Drive_createDoc_closure(this, title, c));
    return c.future;
  },
  loadDoc$1: function(fileId) {
    var c = $._AsyncCompleter$();
    $.load$4$x(this.gapi.get$drive().get$realtime(), fileId, $.Callback$once(new $.Drive_loadDoc_onLoad(this, fileId, c), false), $.Callback$once(this.get$_initializeModel(), false), $.Callback$once(new $.Drive_loadDoc_onError(), false));
    return c.future;
  },
  _loadApi$2: function($name, version) {
    var c = $._AsyncCompleter$();
    $.load$3$x($.get$client$x(this.gapi), $name, version, $.Callback$once(new $.Drive__loadApi_closure($name, c), false));
    return c.future;
  },
  _initializeModel$1: function(model) {
    var $frames, i;
    $frames = model.createList$0();
    for (i = 0; i < 8; ++i)
      $frames.push$1(model.createList$0());
    model.getRoot$0().set$2("frames", $frames);
  },
  get$_initializeModel: function() {
    return new $.BoundClosure$1(this, "_initializeModel$1");
  }
},

Drive_createDoc_closure: {"": "Closure;this_0,title_1,c_2",
  call$1: function(x) {
    var t1, t2;
    t1 = $.get$files$x($.get$client$x(this.this_0.get$gapi()).get$drive());
    t2 = $.makeLiteralMap(["resource", $.makeLiteralMap(["mimeType", "application/vnd.google-apps.drive-sdk", "title", this.title_1])]);
    $._enterScopeIfNeeded();
    $.insert$1$ax(t1, $._deserialize($._jsPortConvert.callSync$1($.Proxy__serializeDataTree(t2)))).execute$1($.Callback$once(new $.Drive_createDoc__closure(this.c_2), false));
  },
  $isFunction: true
},
...
Drive_createDoc__closure: {"": "Closure;c_3",
  call$2: function(fileInfo, unused) {
    var t1, t2;
    t1 = $.getInterceptor$x(fileInfo);
    $.Primitives_printString("document " + $.S(t1.get$id(fileInfo)) + " created");
    t2 = this.c_3;
    t1 = t1.get$id(fileInfo);
    if (t2._isComplete)
      $.throwExpression(new $.StateError("Future already completed"));
    t2._isComplete = true;
    t2._setFutureValue$1(t1);
...
Drive_loadDoc_onLoad: {"": "Closure;this_0,fileId_1,c_2",
  call$1: function(jsDoc) {
    var t1, doc;
    t1 = this.this_0.get$gapi();
    $._jsGlobalize.callSync$1($._serialize(jsDoc.toJs$0()));
    doc = $.Doc$(t1, jsDoc);
    $.Primitives_printString("document " + $.S(this.fileId_1) + " loaded");
    t1 = this.c_2;
    if (t1._isComplete)
      $.throwExpression(new $.StateError("Future already completed"));
    t1._isComplete = true;
...
Drive_loadDoc_onError: {"": "Closure;",
  call$1: function(err) {
    window.alert($.get$message$x(err));
...
CollaborativeList: {"": "Object;proxy<",
  get$id: function(_) {
    return $.get$id$x(this.proxy);
  },
  get$length: function(_) {
    return $.get$length$asx(this.proxy);
  },
  $index: function(_, index) {
    return $.get$1$x(this.proxy, index);
  },
  map$1: function(_, mapper) {
    return $.List_List$generate($.get$length$asx(this.proxy), new $.CollaborativeList_map_closure(this, mapper), true);
  },
  get$map: function(receiver) {
    return new $.BoundClosure$i1(this, "map$1", receiver);
  },
  push$1: function(item) {
    this.proxy.push$1(item);
  },
  removeValue$1: function(item) {
    this.proxy.removeValue$1(item);
  },
  addEventListener$2: function(eventType, callback) {
    this.proxy.addEventListener$2(eventType, $.Callback$many(callback, false));
  }
},

CollaborativeList_map_closure: {"": "Closure;this_0,mapper_1",
  call$1: function(i) {
    return this.mapper_1.call$1($.get$1$x(this.this_0.get$proxy(), i));
  },
  $isFunction: true
},
...
CollaborativeMap: {"": "Object;proxy<",
  ...
  $index: function(_, key) {
    return $.get$1$x(this.proxy, key);
  },
  $indexSet: function(_, key, value) {
    return this.proxy.set$2(key, value);
  }
},
...
Editor: {"": "Object;movie,actions<,top*,redos,onCanUndo,onCanUndoSink,onCanRedo,onCanRedoSink",
  paint$4: function(g, x, y, colorIndex) {
    ...
    if (!couldUndo) {
      t1 = this.onCanUndoSink._sink.stream;
      t1._add$1(t1, true);
    }
    if (t3 !== 0) {
      t1 = this.onCanRedoSink._sink.stream;
      t1._add$1(t1, false);
    }
  },
  endPaint$0: function() {
  ...
  Editor$1: function(movie) {
    var t1, control, control2;
    t1 = new $._SingleControllerStream(null, null, null, null, null, 0, null);
    t1._updatePauseCount$1(1);
    control = new $.StreamController(t1);
    this.onCanUndo = control.stream.asBroadcastStream$0();
    this.onCanUndoSink = new $._EventSinkView(control);
    t1 = new $._SingleControllerStream(null, null, null, null, null, 0, null);
    t1._updatePauseCount$1(1);
    control2 = new $.StreamController(t1);
    this.onCanRedo = control2.stream.asBroadcastStream$0();
...
StrokeSet: {"": "Object;colorIndex<,strokes<",
  ...
  endPaint$0: function() {
    for (var t1 = new $.HashMapKeyIterable(this.strokes), t1 = t1.get$iterator(t1); t1.moveNext$0();)
      t1.get$current().endPaint$0();
  },
  undo$0: function() {
    var t1, t2, g;
    for (t1 = this.strokes, t2 = new $.HashMapKeyIterable(t1), t2 = t2.get$iterator(t2); t2.moveNext$0();) {
      g = t2.get$current();
...
StrokeGrid: {"": "Object;frame<,grid<,pixelStacks,strokes<,top*",
  ...
  getStack$2$bailout: function(state0, x, y, t3, t2, t1) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
...
ColorGrid: {"": "Object;palette,width>,height>,bgColor,all<,buf,onChange>,onChangeSink<",
  setColor$3: function(x, y, colorIndex) {
    ...
    c.fillRect(x, y, 1, 1);
    t1 = this.onChangeSink._sink.stream;
    t1._add$1(t1, new $.Rect(x, y, 1, 1));
  },
  render$3: function(c, pixelsize, clip) {
    var t1;
  ...
  ColorGrid$4: function(palette, width, height, bgColor) {
    var t1, c, t2, controller;
    t1 = this.buf;
    $.set$width$x(t1, width);
    $.set$height$x(t1, height);
    c = $.get$context2D$x(t1);
    t1 = this.palette.colors;
    t2 = this.bgColor;
    if (t2 < 0 || t2 >= t1.length)
      throw $.ioore(t2);
    ...
    t2 = new $._SingleControllerStream(null, null, null, null, null, 0, null);
    t2._updatePauseCount$1(1);
    controller = new $.StreamController(t2);
    this.onChange = controller.stream.asBroadcastStream$0();
...
PaletteModel: {"": "Object;colors<,selected',onChange>,onChangeSink<",
  PaletteModel$1: function(colors) {
    ...
    t1 = new $._SingleControllerStream(null, null, null, null, null, 0, null);
    t1._updatePauseCount$1(1);
    controller = new $.StreamController(t1);
    this.onChange = controller.stream;
    this.onChangeSink = new $._EventSinkView(controller);
  }
},
...
PaletteView: {"": "Object;m<,elt<,cells",
  _initTable$1: function(width) {
    ...
    for (t1 = this.m.colors, t2 = this.cells, t3 = t2.length, t4 = this.elt, i = 0; i < t1.length; ++i) {
      ...
      td.get$dataset;
      new $._DataAttributeMap(new $._ElementAttributeMap(td)).$$dom_attributes._element.setAttribute("data-id", $.JSNumber_methods.toString$0(i));
      t5 = td.style;
      if (i >= t1.length)
        throw $.ioore(i);
      t6 = t1[i];
...
PaletteView_closure: {"": "Closure;this_0",
  call$1: function(e) {
    ...
    if (id != null) {
      ...
      $._add$1$x($.get$stream$x(t1.get$onChangeSink().get$_sink()), t1);
    }
  },
  $isFunction: true
},
...
GridView: {"": "Object;grid<,editor<,pixelsize<,elt<,damage@,_cancelOnChange",
  ...
  setModel$1: function(newG) {
    ...
    t3 = t1.get$height(t2);
    if (t3 == null ? newHeight != null : t3 !== newHeight)
      t1.set$height(t2, newHeight);
...
FrameListView: {"": "Object;player<,elt<,views",
  ...
  FrameListView$3: function(movie, ed, player) {
    ...
    for (t1 = this.elt, t2 = this.views, i = 0; i < grids.length; ++i) {
      ...
      t4.add$1(t4, "frame");
      t3.get$dataset;
      new $._DataAttributeMap(new $._ElementAttributeMap(t3)).$$dom_attributes._element.setAttribute("data-id", $.JSNumber_methods.toString$0(i));
      t1.appendChild(t3);
      t2.push(v);
    }
    t1.get$onClick;
...
FrameListView_closure: {"": "Closure;this_0",
  call$1: function(e) {
    ...
    if (id != null) {
      ...
      t1.set$frame(t2);
      $._add$1$x($.get$stream$x(t1.get$_onFrameChangeSink().get$_sink()), t2);
    }
  },
  $isFunction: true
},
...
main_closure: {"": "Closure;loc_0",
  call$1: function(drive) {
    ...
    fileId = $.getFileId(t1);
    if (fileId == null)
      drive.createDoc$1("PixelCycle Test").then$1(new $.main__closure(t1));
    else
      drive.loadDoc$1(fileId).then$1($.startApp$closure);
  },
  $isFunction: true
},

main__closure: {"": "Closure;loc_1",
  call$1: function(id) {
    var t1;
    $.Primitives_printString("reloading page");
    t1 = this.loc_1;
    $.replace$1$x(t1, $.makeUrl(t1, id));
  },
  $isFunction: true
},
...
PlayerModel: {"": "Object;movie,frame@,onFrameChange,_onFrameChangeSink<,_playing<,_reverse<,fps,onSettingChange,_onSettingChangeSink,_ticker",
  setFramesPerSecond$1: function(newValue) {
    ...
    if ($.$eq(this.fps, newValue))
      return;
    this.fps = newValue;
    t1 = this._onSettingChangeSink._sink.stream;
    t1._add$1(t1, this);
  },
  ...
  _step$1: function(amount) {
    ...
    this.frame = next;
    t1 = this._onFrameChangeSink._sink.stream;
    t1._add$1(t1, next);
  },
  PlayerModel$1: function(movie) {
    var t1, controller, controller2;
    t1 = new $._SingleControllerStream(null, null, null, null, null, 0, null);
    t1._updatePauseCount$1(1);
    controller = new $.StreamController(t1);
    this.onFrameChange = controller.stream.asBroadcastStream$0();
    this._onFrameChangeSink = new $._EventSinkView(controller);
    t1 = new $._SingleControllerStream(null, null, null, null, null, 0, null);
    t1._updatePauseCount$1(1);
    controller2 = new $.StreamController(t1);
    this.onSettingChange = controller2.stream.asBroadcastStream$0();
...
Doc$: function(gapi, doc) {
  var t1 = new $.Doc(gapi, doc, new $.HashMap(0, null, null, null, null));
  t1.Doc$2(gapi, doc);
  return t1;
},
...
Stroke$: function(map, colorIndex) {
  var t1 = new $.Stroke(map, colorIndex, $.List_List($), $.List_List($), new $.HashMap(0, null, null, null, null));
  t1.Stroke$2(map, colorIndex);
  return t1;
},
...
PaletteModel_PaletteModel$standard: function() {
  ...
  t2 = new $._SingleControllerStream(null, null, null, null, null, 0, null);
  t2._SingleStreamImpl$0();
  controller = new $.StreamController(t2);
  t1.onChange = controller.stream;
...
spectrum: function(s, v) {
  var result, t1, t2, t3;
  result = $.List_List($);
  for (t1 = $.JSArray_methods.get$iterator([0, 15, 30, 45, 60, 80, 120, 160, 180, 200, 220, 240, 260, 280, 300, 330]); t1.moveNext$0();) {
    t2 = $.Color_Color$hsv($.$div$n(t1.get$current(), 360), s, v);
    t3 = $.getInterceptor$x(t2);
...
getFileId: function(loc) {
  var t1 = $.getInterceptor$x(loc);
  if ($.$eq(t1.get$search(loc), ""))
    return;
  return $.substring$1$s(t1.get$search(loc), 1);
},

makeUrl: function(loc, fileId) {
  var t1, url;
  t1 = $.toString$0(loc);
  url = $.Uri$_fromMatch($.get$Uri__splitRe().firstMatch$1(t1));
  url = new $.Uri(url.scheme, "", url.domain, url.port, url.path, fileId, "");
  return url.toString$0(url);
},
...
startApp: function(doc) {
  ...
  $._add$1$x($.get$stream$x(pm.get$onChangeSink().get$_sink()), pm);
...
$._add$1$x = function(receiver, a0) {
  return $.getInterceptor$x(receiver)._add$1(receiver, a0);
};
...
$.load$4$x = function(receiver, a0, a1, a2, a3) {
  return $.getInterceptor$x(receiver).load$4(receiver, a0, a1, a2, a3);
};
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "get$g,get$m,get$p,call$0,call$1,call$2,call$3,call$4,eval$1,get$sb,get$xs,get$ys,push$1,redo$0,redo$1,then$1,toJs$0,undo$0,undo$1,_redo$1,_step$1,_undo$1,get$_id,get$all,get$elt,paint$3,_paint$2,get$_key,get$gapi,get$grid,listen$1,lookup$1,render$0,render$3,toJson$0,_cancel$1,execute$1,get$_next,get$_sink,get$drive,get$frame,get$proxy,loadDoc$1,perform$1,process$0,set$_next,set$frame,_handler$0,_onError$1,callSync$1,endPaint$0,get$_state,get$_value,get$colors,get$damage,get$editor,get$player,get$slider,moveNext$0,set$_state,set$_value,set$damage,visitMap$1,_callback$2,_dispatch$1,_sendData$1,_sendDone$0,authorize$2,createDoc$1,createMap$0,get$actions,get$current,get$strokes,set$_handle,set$playing,set$reverse,visitList$1,_sendError$1,_sendValue$1,catchError$1,createList$0,get$_handler,get$_playing,get$_reverse,get$realtime,propExists$2,toSendPort$0,unregister$1,_needsEvent$1,_setGlobals$0,get$EventType,get$_callback,get$_contents,get$_duration,get$_nextLink,get$_previous,get$_registry,get$_workerId,get$frameById,get$pixelsize,readClasses$0,removeValue$1,renderAsync$1,set$_contents,set$_nextLink,set$_previous,createStroke$1,get$VALUES_SET,get$_isolateId,get$colorIndex,get$startIndex,runIteration$0,_checkReplyTo$1,get$_futurePort,visitSendPort$1,get$VALUES_ADDED,get$_liblib2$_id,get$_receivePort,get$onChangeSink,visitPrimitive$1,get$_liblib$_name,get$_nextListener,get$_previousLink,get$_subscription,set$_nextListener,set$_previousLink,set$_subscription,set$scheduleTimer,visitCloseToken$1,_liblib5$_onData$1,_setUnsubscribed$0,addEventListener$2,get$VALUES_REMOVED,get$_cancelOnError,visitIsolateSink$1,visitSendPortSync$1,_liblib0$_callback$1,deserializeSendPort$1,get$_liblib1$_element,_toggleEventReceived$0,get$_onFrameChangeSink,get$_resultOrListeners,deserializeCloseToken$1,_setPendingUnsubscribe$1,deserializeIsolateSink$1,get$_isPendingUnsubscribe".split(","), longNames = "g,m,p,call,call,call,call,call,eval,sb,xs,ys,push,redo,redo,then,toJs,undo,undo,_redo,_step,_undo,_id,all,elt,paint,_paint,_key,gapi,grid,listen,lookup,render,render,toJson,_cancel,execute,_next,_sink,drive,frame,proxy,loadDoc,perform,process,_next=,frame=,_handler,_onError,callSync,endPaint,_state,_value,colors,damage,editor,player,slider,moveNext,_state=,_value=,damage=,visitMap,_callback,_dispatch,_sendData,_sendDone,authorize,createDoc,createMap,actions,current,strokes,_handle=,playing=,reverse=,visitList,_sendError,_sendValue,catchError,createList,_handler,_playing,_reverse,realtime,propExists,toSendPort,unregister,_needsEvent,_setGlobals,EventType,_callback,_contents,_duration,_nextLink,_previous,_registry,_workerId,frameById,pixelsize,readClasses,removeValue,renderAsync,_contents=,_nextLink=,_previous=,createStroke,VALUES_SET,_isolateId,colorIndex,startIndex,runIteration,_checkReplyTo,_futurePort,visitSendPort,VALUES_ADDED,_id,_receivePort,onChangeSink,visitPrimitive,_name,_nextListener,_previousLink,_subscription,_nextListener=,_previousLink=,_subscription=,scheduleTimer=,visitCloseToken,_onData,_setUnsubscribed,addEventListener,VALUES_REMOVED,_cancelOnError,visitIsolateSink,visitSendPortSync,_callback,deserializeSendPort,_element,_toggleEventReceived,_onFrameChangeSink,_resultOrListeners,deserializeCloseToken,_setPendingUnsubscribe,deserializeIsolateSink,_isPendingUnsubscribe".split(",");
